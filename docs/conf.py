...
latex_documents = [
    ('index', 'ThriftPy.tex', 'ThriftPy Documentation',
     'Lx Yu', 'manual'),
]
...
texinfo_documents = [
    ('index', 'ThriftPy', 'ThriftPy Documentation',
     'Lx Yu', 'ThriftPy', 'Pure python implementation of Thrift python lib',
     'Miscellaneous'),
]
